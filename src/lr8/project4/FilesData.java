...
public class FilesData {
    public static void main(String[] args) {
        try {
            //Создание исходного файла numsIsh.txt и запись в него чисел типа float
            File f1 = new File("src/lr8/project4/text.txt");
            f1.createNewFile();
            ...
            File f2 = new File("src/lr8/project4/text2.txt");
            f2.createNewFile();
